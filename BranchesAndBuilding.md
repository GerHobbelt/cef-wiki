...
|:---------------------------|:----------------------------|:-------------------------|
Win 7+, VS2015u1 or VS2015u2 RC, Win10.0.10586 SDK, Ninja | OS X 10.6-10.11, 10.7+ build system, 10.6+ deployment target, 10.10 base SDK, Xcode 3.2.6-7.x, Ninja, 64-bit only | Ubuntu 14.04+, Debian Wheezy+, Ninja |
