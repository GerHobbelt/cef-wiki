...
- [Windows 10.0.15063.468 SDK](https://developer.microsoft.com/en-us/windows/downloads/sdk-archive) installed in the default location. You must install this exact SDK version to avoid build issues.
